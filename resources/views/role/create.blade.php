        ...
        <div class="white-box">
            ...
            <form action="{{ route('roles.store') }}" method="POST" class="form-horizontal">
                ...
                <div class="form-group @error('name') has-error @enderror">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="Masukkan nama role" required>
                ...
                <div class="form-group @error('description') has-error @enderror">
                    ...
                    <div class="col-md-9">
                        <textarea name="description" class="form-control" rows="3" placeholder="Masukkan deskripsi role">{{ old('description') }}</textarea>
