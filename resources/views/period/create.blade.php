...
<div class="row bg-title">
    <div class="col-lg-4 col-md-5 col-sm-5 col-xs-12">
        <h4 class="page-title">Tambah Periode</h4>
    </div>
...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        <div class="white-box">
            ...
            <form action="{{ route('periods.store') }}" method="POST" class="form-horizontal">
                @csrf
                <div class="form-group @error('name') has-error @enderror">
                    <label class="col-md-3 control-label">Nama Periode <span class="text-danger">*</span></label>
                    <div class="col-md-9">
                        <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="Contoh: Periode 2025/2026 Ganjil" required>
